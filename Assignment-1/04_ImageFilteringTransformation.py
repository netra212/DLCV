...
# 1. Filtering: Apply a Gaussian blur to the image to reduce noise and smooth the image. 
# 2. Transformation: Apply a rotation to the image by a specified angle. 
